...
Inside a year, the platform reached 73,000+ customers and moved over $1M in transaction volume, while staying within the ops capacity of a small team.`,
  ...
  },
  {
    ...
    title: "LiveClasses",
    tag: "EdTech",
    role: "Founding Engineer · LiveClasses",
    status: "Exited",
    date: "2021-03-01",
    blurb:
...
const sortedProjects: Project[] = [...projectData].sort(
  (a, b) => new Date(b.date).getTime() - new Date(a.date).getTime(),
);

export const projects: Project[] = sortedProjects;
...
export function splitMetric(metric: string): MetricParts {
